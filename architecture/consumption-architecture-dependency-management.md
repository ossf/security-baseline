...
* [TUF](https://github.com/theupdateframework) is a framework for securing software update systems. OpenSSF RSTUF is an implementation of TUF and abstracts the implementation details from RSTUF consumers into API calls.
