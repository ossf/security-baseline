...
* OSS Metadata Generation, Storage and Verification ( SBOM, VEX, Attestation, Provenance, TUF Metadata)
  ...
  * [vexctl](https://github.com/openvex/vexctl) is a flagship project under [OpenVEX](https://github.com/openvex). OpenVEX is a specification, a Go library and a set of tools for VEX. vexctl generates, merges and attest VEX statements.       
